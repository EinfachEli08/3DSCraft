...
.Ltext0:
	...
	.file 1 "C:/Users/Elias/CLionProjects/3DSCraft/source/gui/DebugUI.c"
...
.LVL0:
	.loc 1 19 20 discriminator 1 view .LVU3
.LBE2:
...
.LBB3:
	...
	.loc 1 20 17 is_stmt 0 view .LVU6
	mov	r1, #1
	mov	r0, #128
	bl	calloc
.LVL2:
	.loc 1 20 15 discriminator 1 view .LVU7
	str	r0, [r4, #4]!
	.loc 1 21 3 is_stmt 1 view .LVU8
	.loc 1 19 27 discriminator 3 view .LVU9
	.loc 1 19 20 discriminator 1 view .LVU10
	cmp	r4, r5
	bne	.L2
	ldr	r4, .L9+4
	add	r5, r4, #60
...
.LBB4:
	...
	.loc 1 24 20 is_stmt 0 view .LVU12
	mov	r1, #1
	mov	r0, #128
	bl	calloc
.LVL3:
	.loc 1 24 18 discriminator 1 view .LVU13
	str	r0, [r4], #4
	.loc 1 25 3 is_stmt 1 view .LVU14
	.loc 1 23 38 discriminator 3 view .LVU15
	.loc 1 23 20 discriminator 1 view .LVU16
	cmp	r4, r5
	bne	.L3
	pop	{r4, r5, r6, pc}
.L10:
...
.LVL4:
	.loc 1 29 20 discriminator 2 view .LVU20
.LBE5:
...
.LVL6:
	...
	.loc 1 29 20 discriminator 2 view .LVU24
	cmp	r4, r5
	bne	.L12
	ldr	r4, .L18+4
	add	r5, r4, #60
...
.LVL7:
	...
	.loc 1 30 20 discriminator 2 view .LVU27
	cmp	r4, r5
	bne	.L13
	pop	{r4, r5, r6, pc}
.L19:
...
.LBB8:
	...
	.loc 1 45 25 discriminator 1 view .LVU55
	.loc 1 45 47 is_stmt 0 discriminator 3 view .LVU56
	mov	r1, r4
	mov	r2, #76
	add	r0, r4, #4
	bl	memmove
.LVL12:
	.loc 1 45 47 discriminator 3 view .LVU57
.LBE8:
...
.LBB9:
	...
	.loc 1 62 20 discriminator 1 view .LVU75
.LBE9:
...
.LBE10:
	.loc 1 62 20 discriminator 1 view .LVU80
	cmp	r5, fp
	beq	.L32
.LVL17:
.L31:
...
.LBE11:
	.loc 1 62 27 discriminator 2 view .LVU86
.LBB12:
...
.LBE12:
	.loc 1 62 20 is_stmt 1 discriminator 1 view .LVU90
.LBB13:
...
.L33:
.LVL21:
	.loc 1 70 3 is_stmt 1 view .LVU97
	.loc 1 71 3 is_stmt 0 view .LVU98
	ldr	ip, [r4]
	mov	r1, r5
	mov	r3, r10
	mov	r2, #100
	...
	str	r8, [sp, #12]
	str	r7, [sp, #8]
	.loc 1 70 7 view .LVU99
	str	r6, [sp, #28]
	.loc 1 71 3 is_stmt 1 view .LVU100
	bl	SpriteBatch_PushText
.LVL22:
	.loc 1 72 3 view .LVU101
	.loc 1 72 11 is_stmt 0 view .LVU102
	ldr	r3, [sp, #28]
	.loc 1 74 3 view .LVU103
	ldr	r0, [r4], #4
	mov	r2, #128
	mov	r1, #0
	.loc 1 72 11 view .LVU104
	add	r5, r5, r3
.LVL23:
	.loc 1 74 3 is_stmt 1 view .LVU105
	bl	memset
.LVL24:
.LBE16:
	.loc 1 69 38 discriminator 3 view .LVU106
	.loc 1 69 20 discriminator 1 view .LVU107
	cmp	r4, r9
	bne	.L33
.LBE15:
...
.Letext0:
	...
	.file 13 "C:/Users/Elias/CLionProjects/3DSCraft/include/gui/SpriteBatch.h"
...
.LASF105:
	.ascii	"C:/Users/Elias/CLionProjects/3DSCraft/source/gui/De"
	.ascii	"bugUI.c\000"
