...
unsigned lodepng_compute_color_stats(LodePNGColorStats* stats, const unsigned char* image, unsigned w, unsigned h,
...
int main(int argc, char *argv[]) {
  const char* filename = argc > 1 ? argv[1] : "test.t3x";
