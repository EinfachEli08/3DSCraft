...
class basic_handle {
	...
	public:
		...
		using iterable =
			iterable_adaptor<internal::handle_storage_iterator<typename decltype(std::declval<registry_type>().storage())::iterator>>;

		/*! @brief Constructs an invalid handle. */
		basic_handle() noexcept : owner{}, entt{null} {}
		 ...
		 */
		basic_handle(registry_type &ref, entity_type value) noexcept : owner{&ref}, entt{value} {}
		...
		/*! @copydoc valid */
		[[nodiscard]] explicit operator bool() const noexcept { return owner && owner->valid(entt); }
		 ...
		 */
		[[nodiscard]] registry_type *registry() const noexcept { return owner; }
		...
		void destroy() { owner_or_assert().destroy(std::exchange(entt, null)); }

		/**
		 * @brief Destroys the entity associated with a handle.
		 * @param version A desired version upon destruction.
		 */
		void destroy(const version_type version) { owner_or_assert().destroy(std::exchange(entt, null), version); }
		 ...
		 */
		[[nodiscard]] bool orphan() const { return owner_or_assert().orphan(entt); }
