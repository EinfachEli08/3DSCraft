...
namespace internal {
	...
	template <>
	struct fnv1a_traits<std::u64> {
			using type						 = std::u64;
			static constexpr std::u64 offset = 14695981039346656037ull;
			static constexpr std::u64 prime	 = 1099511628211ull;
	};
...
class basic_hashed_string : internal::basic_hashed_string<Char> {
	...
	public:
		...
		constexpr basic_hashed_string() noexcept : basic_hashed_string{nullptr, 0u} {}
