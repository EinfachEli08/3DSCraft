...
class basic_any {
		...
		static const void *basic_vtable(const operation op, const basic_any &value, const void *other) {
			...
			if constexpr (in_situ<Type>) {
				element = (value.mode == any_policy::owner) ? reinterpret_cast<const Type *>(&value.storage)
	...
	public:
		 ...
		 */
		template <typename Type, typename... Args>
		explicit basic_any(std::in_place_type_t<Type>, Args &&...args) : instance{}, info{}, vtable{}, mode{any_policy::owner} {
		 ...
		 * @return An opaque pointer the contained instance, if any.
		 */
		[[nodiscard]] void *data() noexcept { return mode == any_policy::cref ? nullptr : const_cast<void *>(std::as_const(*this).data()); }
		...
		/*! @copydoc as_ref */
		[[nodiscard]] basic_any as_ref() const noexcept { return basic_any{*this, any_policy::cref}; }
